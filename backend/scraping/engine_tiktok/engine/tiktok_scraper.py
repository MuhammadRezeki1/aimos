...
# ── CONFIG ────────────────────────────────────────────────────
# Default headless = True agar scraping jalan diam di background.
...
class TikTokScraperV58(TikTokCheckpointMixin):
    ...
    def _parse_metadata(self, meta_raw: Dict) -> Dict:
        default = {
            ...
            "duration": 0, "create_time": 0, "music_title": "", "hashtags": [], "thumbnail_url": "",
        }
    ...
    def scrape_post_comments(self, post_url: str, max_comments: int = 100,
        ...
        result = {
            ...
            "play_count": 0, "digg_count": 0, "share_count": 0, "comment_count": 0,
            "music_title": "", "thumbnail_url": "", "duration": 0,
        ...
        try:
            ...
            for k in ["video_id", "username", "description", "play_count",
                      "digg_count", "share_count", "comment_count", "music_title", "thumbnail_url", "duration"]:
                if meta.get(k):
                    result[k] = meta[k]
